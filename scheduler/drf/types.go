// Package drf: типы данных (PodInfo/NodeInfo) и хелперы для представления запросов ресурсов
// в формате, удобном для алгоритма DRF и интеграции с scheduler framework.
package drf
